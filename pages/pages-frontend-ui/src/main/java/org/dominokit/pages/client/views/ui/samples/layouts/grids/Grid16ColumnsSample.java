...
public class Grid16ColumnsSample extends BaseDominoElement<HTMLDivElement, Grid16ColumnsSample> {
    ...
    public static Grid16ColumnsSample create() {
        return new Grid16ColumnsSample();
    }

    public Grid16ColumnsSample() {
        this.element = div()
                .addCss(dui_p_2)
