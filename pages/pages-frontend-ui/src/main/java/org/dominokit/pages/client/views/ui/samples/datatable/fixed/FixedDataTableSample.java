...
public class FixedDataTableSample extends BaseDominoElement<HTMLDivElement, FixedDataTableSample> {

    private DivElement element;

    public static FixedDataTableSample create() {
        return new FixedDataTableSample();
    }

    public FixedDataTableSample() {
