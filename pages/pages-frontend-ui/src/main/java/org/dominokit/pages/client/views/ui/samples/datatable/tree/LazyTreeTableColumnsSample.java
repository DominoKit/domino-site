...
public class LazyTreeTableColumnsSample extends BaseDominoElement<HTMLDivElement, LazyTreeTableColumnsSample> {

    private DivElement element;

    public static LazyTreeTableColumnsSample create() {
        return new LazyTreeTableColumnsSample();
    }

    public LazyTreeTableColumnsSample() {
