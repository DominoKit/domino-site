...
public class SimplePaginationSample extends BaseDominoElement<HTMLDivElement, SimplePaginationSample> {

    private DivElement element;

    public static SimplePaginationSample create() {
        return new SimplePaginationSample();
    }

    public SimplePaginationSample() {
