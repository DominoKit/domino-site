...
public class HorizontalSpinSample extends BaseDominoElement<HTMLDivElement, HorizontalSpinSample> {

    private DivElement element;

    public static HorizontalSpinSample create() {
        return new HorizontalSpinSample();
    }

    public HorizontalSpinSample() {
        this.element = div().addCss(dui_p_2)
                .appendChild(Row.create()
                        .span2(HSpinSelect.<String>create()
                        ...
                        .span6(HSpinSelect.<String>create(Icons.menu_left(), Icons.menu_right())
                                .addCss(dui_min_h_12)
                                .appendChild(SpinItem.create("item 1")
                                        .appendChild(div()
                                                .addCss(dui_min_h_12, dui_flex, dui_items_center, dui_justify_center)
