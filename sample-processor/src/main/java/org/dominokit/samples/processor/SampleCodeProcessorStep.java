            ...
            try {
                ...
                try {
                    ...
                    if (path.endsWith("target")) {
                        ...
                        TypeSpec.Builder codeResource = DominoTypeBuilder.interfaceBuilder("CodeResource", SamplesProcessor.class)
                            ...
                            parse.ifSuccessful(compilationUnit -> {
                                new VoidVisitorAdapter<>() {
                                    ...
                                    public void visit(MethodDeclaration methodDeclaration, Object arg) {
                                        methodDeclaration.getAnnotationByClass(ComponentSample.class)
                                                .flatMap(annotationExpr -> methodDeclaration.getBody())
                                                .ifPresent(blockStmt -> {
